...
from data_preprocessing import load_inventory_data, prepare_features, split_data
...
def main():
    db_path = r"C:\Users\ACER\Machine learning project\data\inventory.db"
    model_dir = Path("models")
    model_dir.mkdir(exist_ok=True)

    # Load data
    df = load_inventory_data (db_path)
